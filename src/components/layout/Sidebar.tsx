    ...
    <>
      ...
      <aside
        ...
        className={cn(
          ...
          'flex flex-col bg-white dark:bg-gray-900 shadow-lg border-r border-gray-200 dark:border-gray-800',
          ...
          {!isCollapsed && (
            <>
              ...
              <button
                ...
                className="flex items-center w-full px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
