...
export default function TicketsPage() {
  ...
  const handleEditTicket = (ticket: Ticket) => {
    ...
    const ticketDate = ticket.date ? (typeof ticket.date === 'string' ? ticket.date.split('T')[0] : new Date(ticket.date).toISOString().split('T')[0]) : '';
    setFormData({
  ...
  const handleUpdateTicket = async () => {
    if (!selectedTicket || !formData.ticketType || !formData.subject || !formData.description || !formData.priority) {
      alert('Please fill in all required fields');
      return;
    }
      ...
      <div className="space-y-6">
        ...
        >
          <div className="space-y-4 p-6">
            <div>
              <Label htmlFor="userName" className="text-gray-700 mb-1">User Name:</Label>
              <Input
                id="userName"
                value={user?.email || ''}
                disabled
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="ticketType" className="text-gray-700 mb-1"> <span className="text-red-500">*</span> Ticket Type:</Label>
                <Select
                  id="ticketType"
              ...
              <div>
                <Label htmlFor="priority" className="text-gray-700 mb-1"> <span className="text-red-500">*</span> Priority:</Label>
                <Select
                  id="priority"
            ...
            <div>
              <Label htmlFor="subject" className="text-gray-700 mb-1"> <span className="text-red-500">*</span> Subject:</Label>
              <Input
                id="subject"
            ...
            <div>
              <Label htmlFor="description" className="text-gray-700 mb-1"> <span className="text-red-500">*</span> Description:</Label>
              <RichTextEditor
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
              ...
              <Button
                onClick={isEditMode ? handleUpdateTicket : handleCreateTicket}
                disabled={submitting}
          ...
          {selectedTicket && (
            <div className="space-y-4 p-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label className="text-gray-500 text-sm font-normal mb-1 block">Status:</Label>
